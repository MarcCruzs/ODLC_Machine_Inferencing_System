...
def detect_objects(source=None, image_dir=False, conf_threshold=0.25, save_dir=r"/usr/app/src/images", checklist_path="/usr/app/checklist/output.txt"):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--checklist_path', default='/usr/app/checklist/output.txt', help='Path to save the output checklist')

    args = parser.parse_args()
    detect_objects(source=args.source, image_dir=args.image_dir, conf_threshold=args.conf_threshold, save_dir=args.save_dir, checklist_path=args.checklist_path)
